...
![Spring](https://img.shields.io/badge/Spring_Boot_3-6DB33F?style=flat&logo=springboot&logoColor=white)
...
![Elastic](https://img.shields.io/badge/Elasticsearch-005571?style=flat&logo=elasticsearch&logoColor=white)

**IA**
![LangChain](https://img.shields.io/badge/LangChain4j-1C3C3C?style=flat&logo=langchain&logoColor=white)
![RAG](https://img.shields.io/badge/RAG-6366F1?style=flat)
![Agents](https://img.shields.io/badge/Agentic_AI-111827?style=flat)
...
```mermaid
graph LR
    UI[React Dashboard] --> GW[API Gateway]

    subgraph Command Side
        GW --> CMD[Command Handler]
        CMD --> AGG[Aggregate\nAxon Framework]
        AGG --> ES[Event Store]
    end
...
graph TD
    ...
    SvcA --> Kafka[Apache Kafka]
    Kafka --> SvcB

    SvcA --> PG[(PostgreSQL)]
    SvcB --> PG

    SvcA --> OT[OpenTelemetry Collector]
    SvcB --> OT
    OT --> Jaeger[Jaeger / Grafana]
```
...
```mermaid
graph TD
    HTTP[HTTP Request] --> API[API Layer\nControllers]
...
```mermaid
graph LR
    YF[Yahoo Finance API] --> BE[Backend\nGo / .NET / Node]
    BE --> DB[(Database)]
    DB --> BE
    BE --> Web[React / Angular]
    BE --> Mobile[Flutter]
    Web --> Chart[Gráfico de Variação]
    Mobile --> Chart
```
...
![OCP](https://img.shields.io/badge/OCP-Java-ED8B00?style=flat&logo=openjdk&logoColor=white)
![AWS](https://img.shields.io/badge/AWS-Solutions_Architect-FF9900?style=flat&logo=amazonaws&logoColor=white)
![Azure](https://img.shields.io/badge/Azure-Architect-0078D4?style=flat&logo=microsoftazure&logoColor=white)
![CKA](https://img.shields.io/badge/Kubernetes-CKA-326CE5?style=flat&logo=kubernetes&logoColor=white)
![CKAD](https://img.shields.io/badge/Kubernetes-CKAD-326CE5?style=flat&logo=kubernetes&logoColor=white)

---

### 🌐 Conecte-se

[![LinkedIn](https://img.shields.io/badge/LinkedIn-lucasgeek-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://linkedin.com/in/lucasgeek)
...
graph LR
    ...
    BE --> Web[React / Angular]
    BE --> Mobile[Flutter]
    Web --> Chart[Gráfico de Variación]
    Mobile --> Chart
```
